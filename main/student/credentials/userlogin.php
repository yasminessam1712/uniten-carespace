...
$redirect = isset($_SESSION['redirect_after_login']) ? $_SESSION['redirect_after_login'] : '../mainpage.php';
$login_error = "";
...
<div class="container">
    <div class="left-info">
        ...
        <h1>Welcome to Carespace</h1>
        <p>Your mental wellbeing is essential. Access professional support and resources tailored for students.</p>
    </div>

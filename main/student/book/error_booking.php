...
<div class="success-box">
    <h2>Oh no!</h2>
    <p>The selected slot clashes with your current appointments. <br><br>Please choose a different slot.</p>
    <a href="book_appointment.php" class="btn">Go Back to Booking</a>
